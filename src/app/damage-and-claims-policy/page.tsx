// src/app/damage-and-claims-policy/page.tsx
...
const PAGE_SLUG = "damage-and-claims-policy";
...
export default async function DamageAndClaimsPolicyPage() {
  try {
    const pageData = await getContentPageData(PAGE_SLUG);
          ...
          {pageData.imageUrl && (
              <div className="relative w-full aspect-video rounded-xl overflow-hidden mb-8 shadow-lg">
                  <AppImage 
                      ...
                      aiHint={pageData.imageHint || "damage policy banner"}
                  />
              </div>
          )}
