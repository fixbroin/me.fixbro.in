...
export default function CheckoutPage() {
  ...
  useEffect(() => {
    ...
    const savedSlot = localStorage.getItem('wecanfixScheduledTimeSlot');
    const savedEndTime = localStorage.getItem('wecanfixEstimatedEndTime');
    const savedAddressRaw = localStorage.getItem('wecanfixCustomerAddress');
    const savedPromoRaw = localStorage.getItem('wecanfixAppliedPromoCode');
  ...
  const handleScheduleSelect = (date: Date, slot: string, endTime: string, interveningBreaks: any[], dailyTimeline?: any[]) => {
    ...
    localStorage.setItem('wecanfixScheduledDate', date.toLocaleDateString('en-CA'));
    localStorage.setItem('wecanfixScheduledTimeSlot', slot);
    localStorage.setItem('wecanfixEstimatedEndTime', endTime);
    localStorage.setItem('wecanfixInterveningBreaks', JSON.stringify(interveningBreaks));
    localStorage.setItem('wecanfixDailyTimeline', JSON.stringify(dailyTimeline || []));
  ...
  const handleAddressSelect = (address: Address) => {
    ...
    localStorage.setItem('wecanfixCustomerAddress', JSON.stringify(address));
    localStorage.setItem('wecanfixCustomerEmail', address.email || "");
