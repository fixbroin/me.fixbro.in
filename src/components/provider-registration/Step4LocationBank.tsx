  ...
  return (
    <Form {...form}>
      ...
      <Dialog open={isMapModalOpen} onOpenChange={(open) => { if (!open) setIsMapModalOpen(false); }}>
        <DialogContent className="max-w-3xl w-[95vw] h-[85vh] p-0 flex flex-col" onPointerDownOutside={(e) => e.preventDefault()} onEscapeKeyDown={(e) => e.preventDefault()} hideCloseButton={true}>
